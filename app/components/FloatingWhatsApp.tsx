...
const FloatingWhatsApp = () => {
    ...
    return (
        <button
            ...
            className="floating-whatsapp fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-all duration-300 ease-in-out transform hover:scale-110 hover:shadow-xl group sm:bottom-6 sm:right-6 sm:p-4"
